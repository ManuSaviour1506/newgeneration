...
const sectionsData = [
  ...
  },
  {
    ...
    text: "At our school, we follow a child-centric curriculum aligned with the CBSE, focusing on holistic development from Kindergarten through Primary classes. In Kindergarten (Pre-KG to UKG), learning is play-based and activity-oriented, helping children build foundational skills in language, numbers, social interaction, and motor development in a joyful and nurturing environment. In the Primary section (Classes I to V), the curriculum emphasizes conceptual understanding in core subjects like English, Mathematics, Environmental Studies, and Hindi, along with co-curricular areas such as Art, Computer Education, and Physical Development. Our approach encourages curiosity, creativity, and confidence in every child, laying a strong foundation for lifelong learning.",
