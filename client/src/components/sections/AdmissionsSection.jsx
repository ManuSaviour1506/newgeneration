...
function AdmissionsSection() {
  ...
  const admissionsImageUrl =
    "https://res.cloudinary.com/dlexfctt4/image/upload/v1755712099/WhatsApp_Image_2025-08-20_at_21.17.36_wrfqdt.jpg ";
            ...
            <div className="bg-[#9ACD32] p-8 rounded-lg shadow-md">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <input
                  ...
                  required
                  className="p-3 border rounded-md mb-6 w-full"
                />
