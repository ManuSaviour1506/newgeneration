...
const YoutubeIcon = () => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0C.887 3.427 0 4.926 0 8.25c0 3.324.887 4.823 4.385 5.066 3.6.245 11.626.246 15.23 0 3.5-.243 4.385-1.742 4.385-5.066 0-3.324-.885-4.823-4.385-5.066zM9.75 11.01V5.49a.75.75 0 011.125-.65l5.25 2.76a.75.75 0 010 1.3l-5.25 2.76a.75.75 0 01-1.125-.65z"
      clipRule="evenodd"
    />
  </svg>
);
...
const LocationIcon = () => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M9.69 18.933l.003.001C9.89 19.02 10 19 10 19s.11.02.308-.066l.002-.001.006-.003.018-.008a5.741 5.741 0 00.281-.14c.186-.1.4-.27.666-.478.354-.275.755-.636 1.199-1.085.445-.45.926-.99 1.461-1.604a11.848 11.848 0 002.463-3.843C16.6 9.26 17 7.96 17 6.75 17 4.125 14.875 2 12.25 2S7.5 4.125 7.5 6.75c0 1.21.4 2.51 1.077 3.692.652 1.172 1.458 2.275 2.463 3.843.535.614 1.016 1.154 1.461 1.604.444.449.845.81 1.199 1.085.266.208.48.378.666.478a5.741 5.741 0 00.281.14l.018.008.006.003zM10 8a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"
      clipRule="evenodd"
    />
  </svg>
);
